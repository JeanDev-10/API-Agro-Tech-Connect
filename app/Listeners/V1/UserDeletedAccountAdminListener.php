...
use App\Notifications\V1\UserDeletedAccountAdminNotification;
use App\Notifications\V1\UserDeletedAccountNotification;
use Illuminate\Contracts\Queue\ShouldQueue;
use Illuminate\Queue\InteractsWithQueue;
use Illuminate\Support\Facades\Notification;

class UserDeletedAccountAdminListener
{
    /**
     ...
     * Handle the event.
     */
    public function handle(UserDeletedAccountAdmintEvent $event): void
    {
        Notification::send($event->user,new UserDeletedAccountAdminNotification());
    }
}
