...
class AuthRepository implements AuthRepositoryInterface
{
    ...
    public function userProfile()
    {
        ...
        $user = User::where('id', $id)->with('roles', 'ranges', 'image', 'followings.followed', 'followers.follower', 'posts', 'comments', 'replayComments', 'reactions', 'complaints', 'userInformation')->withCount([
            'followers',
            'followings',
            'posts',
            'comments'
